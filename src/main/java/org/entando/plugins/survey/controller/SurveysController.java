...
public class SurveysController {
    ...
    @GetMapping(path = "/{uuid}/submissions/export", produces = { APPLICATION_JSON_VALUE, APPLICATION_PDF_VALUE })
    ...
    @GetMapping(path = "/{uuid}/submissions/{submissionUuid}/export", produces = { APPLICATION_JSON_VALUE, APPLICATION_PDF_VALUE })
